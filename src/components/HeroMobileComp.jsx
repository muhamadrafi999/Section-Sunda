    ...
    <section className="relative w-full h-[930px] overflow-hidden bg-[#F7F0DE]">
      ...
      <div className="absolute top-[320px] left-1/2 -translate-x-1/2 w-[255px] h-[390px] z-20">
        ...
        <img
          src={BrideGroom}
          alt=""
          className="absolute left-1/2 -translate-x-1/2 top-[18px] w-[208px] h-[345px] rounded-t-[120px] rounded-b-[120px] object-cover z-10"
        />

        <img
          src={Flower17}
          alt=""
          className="absolute -left-[92px] bottom-[4px] w-[200px] z-30 animate-left-bush"
        />

        <img
          src={Flower13}
          alt=""
          className="absolute -left-[78px] bottom-[18px] w-[160px] z-40 animate-left-flower"
        />

        <img
          src={Flower28}
          alt=""
          className="absolute right-[2px] bottom-[10px] w-[96px] z-40 animate-tall-flower"
        />

        <img
          src={Flower30}
          alt=""
          className="absolute right-[18px] bottom-[8px] w-[52px] z-50 animate-right-flower"
        />

        <img
          src={TopRightFlower}
          alt=""
          className="absolute right-0 bottom-[34px] w-[120px] z-50 animate-top-flower"
        />
