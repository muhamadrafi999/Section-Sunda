...
function WeddingGiftComp() {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("083751800779");
    setCopied(true);
    setTimeout(() => {
      setCopied(false);
    }, 2000);
          ...
          <div className="absolute top-17.5 left-1/2 -translate-x-1/2 w-84.5 h-160">
            ...
            <div className="absolute inset-0 flex flex-col items-center pt-13.75 z-20">
              ...
              <div className="mt-8 w-75 rounded-xl bg-[#7B2A2A] px-3 py-3 flex flex-col items-center">
                ...
                <button
                  onClick={handleNext}
                  className="mt-3 w-71.25 h-8.5 rounded-full bg-white font-body text-[14px] text-[#6A4540] hover:scale-[1.02] duration-200 cursor-pointer"
                >
                  Selanjutnya ›
                </button>
              </div>
