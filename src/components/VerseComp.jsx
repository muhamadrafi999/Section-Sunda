    ...
    <section className="bg-[#F7F0DE] pt-10 pb-2 flex justify-center overflow-hidden">
      <div className="relative w-[390px] h-[390px]">
        ...
        <img
          src={Paper}
          alt=""
          className="absolute left-1/2 top-[30px] -translate-x-1/2 w-[365px] z-20"
        />

        <div className="absolute left-1/2 top-[65px] -translate-x-1/2 w-[235px] z-30">
        ...
        <img
          src={RightFlower}
          alt=""
          className="absolute right-0 bottom-[70px] w-[130px] z-40 animate-right-flower"
        />
