...
function LiveFootageComp() {
  return (
    <section className="bg-[#F7F0DE] py-16">
      <div className="w-97.5 mx-auto flex flex-col items-center">
        ...
        <div className="relative w-78.75">
          <img
            src={Video}
            alt=""
          ...
          <img
            src={TopRightFlower}
            alt=""
            className="absolute top-1 -right-5 w-22 animate-top-flower"
          />
          <img
            src={BottomRightFlower}
            alt=""
            className="absolute bottom-0 -right-7 w-22 animate-bottom-flower"
          />
        </div>
        <div className="flex flex-col items-center mt-16">
          ...
          <div className="relative w-78.75">
            ...
            <img
              ...
              alt=""
              className="absolute -bottom-7 -left-7 w-23.75 animate-top-flower"
            />
          </div>
        </div>
      </div>
