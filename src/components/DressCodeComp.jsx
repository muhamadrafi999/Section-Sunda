    ...
    <section className="bg-[#F7F0DE] py-16 flex justify-center overflow-hidden">
      ...
      <div className="relative w-[390px] flex flex-col items-center">
        ...
        <div className="flex gap-4">
          ...
          <div className="w-[160px] h-[300px] rounded-[24px] bg-[#EEDDCB] shadow-[0_0_12px_rgba(0,0,0,.18)] flex flex-col items-center pt-6">

            <h2 className="font-body text-[22px] text-[#6B4A3E]">
              Pria
            </h2>

            <div className="w-[68px] h-[68px] rounded-full bg-white flex items-center justify-center mt-5">
        ...
        <img
          src={ManyLeftFlower}
          alt=""
          className="absolute left-[-8px] bottom-[-6px] w-[120px] animate-left-bush"
        />

        <img
          src={YellowRedFlower}
          alt=""
          className="absolute right-[-10px] bottom-0 w-[105px] animate-right-flower"
        />
